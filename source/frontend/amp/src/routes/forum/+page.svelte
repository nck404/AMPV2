                ...
                {:else}
                    {#each filteredPosts as post, i}
                        <button
                            ...
                            class="w-full text-left glass p-5 md:p-8 rounded-[2rem] md:rounded-[3rem] border border-overlay/60 hover:bg-surface/95 transition-all duration-500 group cursor-pointer shadow-sm hover:shadow-xl hover:shadow-rose-text/5 relative"
                        >
